...
def test_main_writes_persons_json(tmp_path):
    raw_dir = tmp_path / "raw"
    raw_dir.mkdir()
    (raw_dir / "a.md").write_text("원문 A", encoding="utf-8")
    (raw_dir / "b.md").write_text("원문 B", encoding="utf-8")
